...
//dipakai di login
$("#modal-2").fireModal({
  title: "Hubungi Admin Segera",
  body: 'Silahkan hubungi Admin untuk memperbarui Kata Sandi Anda.', center: true
});
...
$("#modal-6").fireModal({
  ...
  created: function(modal) {
    modal.find('.modal-footer').prepend('<div class="modal fade" role="dialog" id="verifikasi"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Modal title</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
  },
  buttons: [
    {
      text: 'No Action',
